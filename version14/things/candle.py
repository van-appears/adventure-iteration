...
class Candle(Thing):
    def __init__(self):
        super().__init__(key="candle", carryable=True, described=True)
    ...
    def perform_action(self, action):
        ...
        if verb == "light":
            ...
            elif inventory().has_direct_item_with_key("matches"):
                print("You light the candle with one of the matches. Careful now!")
                inventory().find_items_with_key("matches")[0][1].match_count -= 1
